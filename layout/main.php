...
<nav class="navbar navbar-expand-lg navbar-dark">
  <div class="container">
    <a class="navbar-brand" href="#"><img src="../../assets/img/unhan-logo-2.png"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        ...
        <?php if ($url[3] == "pengguna_app") { ?>
          <a class="nav-item active nav-link" href="<?= base_url()?>system/pengguna_app/index.php">Pengguna APP</a>
        <?php } ?>
        <?php if ($url[3] != "pengguna_app") { ?>
        ...
        <?php if ($url[3] == "informasi_surat") { ?>
          <a class="nav-item active nav-link" href="<?= base_url()?>system/informasi_surat/index.php">Informasi Surat</a>
        <?php } ?>
        <?php if ($url[3] != "informasi_surat") { ?>
          <a class="nav-item nav-link" href="<?= base_url()?>system/informasi_surat/index.php">Informasi Surat</a>
        <?php } ?>

        <?php if ($url[3] == "surat_keluar") { ?>
          <a class="nav-item active nav-link" href="<?= base_url()?>system/surat_keluar/index.php">Surat Keluar</a>
        <?php } ?>
        <?php if ($url[3] != "surat_keluar") { ?>
